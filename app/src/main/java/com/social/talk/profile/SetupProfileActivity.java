package com.social.talk.profile;
...
import com.social.talk.databinding.ActivitySetupProfileBinding;
...
public class SetupProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.profileSetupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String userName = binding.profileSetupEditTextName.getText().toString();
                if (userName.isEmpty()) {
                    binding.profileSetupEditTextName.setError("Please provide your name here first");
                    return;
                }
